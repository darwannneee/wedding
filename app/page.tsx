...
import { Bodoni_Moda, Beau_Rivage, Roboto, Poppins, Vollkorn } from 'next/font/google';
...
export default function Home() {
  ...
  return (
    <div className='overflow-x-hidden'>
      ...
      <section className="py-40 bg-cover bg-center relative" style={{ backgroundImage: `url(${WeddingLanscape.src})` }}>
        <div className="absolute inset-0 bg-black opacity-50"></div>
      ...
      <div className='bg-neutral-200 w-full h-full'>
        <img src={FlowerAtas.src} alt='Bunga Atas' className={`w-full h-auto mb-4 flower animate-flower`} ref={flowerRef} />
        <h1 className={`text-black text-center ${VollkornbBold.className} text-3xl mb-6`}>Beri Ucapan</h1>
        ...
        <div className='px-8'>
          ...
          <button className='w-full p-2 bg- text-white rounded-md bg-pink-800 focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center justify-center space-x-2'>
      ...
      <img src={FlowerBawah.src} alt='Bunga Bawah' className='w-full h-auto mt-4 flower animate-flower' />
    </div>
      ...
      <div className='relative text-center h-screen bg-cover bg-center' style={{ backgroundImage: `url(${FooterImage.src})`, backgroundSize: 'cover' }}>
          ...
          <div className='relative z-20 flex flex-col items-center justify-center h-full px-10'>
              <h1 className={`${PoppinsFont.className} font-bold text-white`}>Cinta adalah kekuatan yang membawa dua jiwa menjadi satu, mewujudkan kebahagiaan yang tak terhingga dalam kesederhanaan kebersamaan.</h1>
              <div className='absolute bottom-10 flex flex-col items-center'>
                  <h1 className={`text-white mb-2 ${PoppinsBold.className}`}>Love, from</h1>
